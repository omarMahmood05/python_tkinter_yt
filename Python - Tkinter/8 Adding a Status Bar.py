...
def forward(image_number):
    ...
    mySlide.grid(row=0, column=0, columnspan=3,  pady=10 ,padx=10)
    ...
    status = Label(root, text="Image " + str(image_number) + " of " + str(len(catImageList)), bd=1, relief=SUNKEN, anchor=E)
...
# Status Start
status = Label(root, text="Image 1 of " + str(len(catImageList)), bd=1, relief=SUNKEN, anchor=E)
# Status End
